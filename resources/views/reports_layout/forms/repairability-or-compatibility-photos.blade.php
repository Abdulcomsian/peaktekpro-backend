    ...
    <div id="compatibility-sections-container">
                                    ...
                                    <div class="flex flex-col flex-wrap w-full">
                                        ...
                                        <div class="mb-2">
                                            <div class="compatibility-dropzone w-full min-h-[200px] border-2 border-dashed border-gray-300 p-4 flex items-center justify-center"
                                                ...
                                                <div class="dz-message text-center text-gray-600">Drop an image here or
                                                    click to upload</div>
                                            </div>
                                        </div>
                                        <!-- Image Preview -->
        ...
        @else
            <div class="compatibility-section bg-white shadow-md rounded-lg mb-6 p-4 border border-gray-200"
                        ...
                        <div class="flex flex-col flex-wrap w-full">
                            ...
                            <div class="mb-2">
                                <div class="compatibility-dropzone w-full min-h-[200px] border-2 border-dashed border-gray-300 p-4 flex items-center justify-center"
                                    ...
                                    <div class="dz-message text-center text-gray-600">Drop an image here or click to
                                        upload
                                    </div>
                                </div>
                            </div>
                ...
                <!-- Add Item Button -->
                <button class="add-compatibility-item-btn text-blue-600 hover:text-blue-700 font-medium text-sm mt-4">+
                    Add
                    Item</button>
            </div>
        @endif
...
@push('scripts')
    <script>
        ...
        `;
                            ...
                            $(`#compatibility-dropzone-${itemId}`).html(imagePreviewHtml)
                                .removeClass("hidden");
                        };
        ...
        $('#compatibility-sections-container').on('input', '.item-editor', function() {
            clearTimeout(typingTimer); // Clear the previous timeout
            const $this = $(this);
