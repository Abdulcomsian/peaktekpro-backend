...
@section('title', 'Create Report Layout')
        ...
        <section class="w-3/4 p-6">
            <div class="p-1 mb-2">
                <div class="flex items-center justify-end space-x-4">
                    <label for="templateId" class="text-gray-700 font-medium">Template</label>
                    <div class="relative w-64">
                        <select name="template_id" id="templateId"
                                class="block w-full py-2 pl-3 pr-10 text-gray-700 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
            ...
            <div class="bg-white shadow p-4 rounded-lg mb-4 mt-2">
