        ...
        return response()->json([
            ...
            'data' => [
                'id'=> $adjustor_meeting_photos->id,
                    ...
                    'exterior_front' => $adjustor_meeting_photos->exterior_front,
                    'exterior_front_left' =>$adjustor_meeting_photos->exterior_front_left,
                    'exterior_left'=>$adjustor_meeting_photos->exterior_left,
                    'exterior_back_left'=>$adjustor_meeting_photos->exterior_back_left,
                    'exterior_back'=>$adjustor_meeting_photos->exterior_back,
                    'exterior_back_right'=>$adjustor_meeting_photos->exterior_back_right,
                    'exterior_right'=>$adjustor_meeting_photos->exterior_right,
                    'exterior_front_right' =>$adjustor_meeting_photos->exterior_front_right,
