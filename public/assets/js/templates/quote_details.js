...
function createRow() {
    return `
    <div class="row flex items-center space-x-4" data-id="row_${sectionCounter}">
    ...
    <div class="section bg-white shadow-md rounded-lg mb-6 p-4 border border-gray-200" data-id="section_${sectionCounter}">
        <div class="flex justify-between items-center mb-4">
            ...
            <div class="relative flex items-center">
                <span id="toggle-tooltip" class="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 text-sm bg-black text-white px-2 py-1 rounded-md hidden">
                    Total will be included.
                </span>
                <label class="relative inline-flex items-center cursor-pointer">
                    <input type="checkbox" class="sr-only peer section-toggle">
                    <div class="w-11 h-6 bg-gray-200 rounded-full peer peer-focus:ring-2 peer-focus:ring-blue-500 peer-checked:after:translate-x-full peer-checked:after:border-white peer-checked:bg-blue-600 after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all"></div>
                </label>
            </div>
        </div>
